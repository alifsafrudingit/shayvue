            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                >
                  ...
                  >
                    <div
                      v-for="miniPicture in productDetails.galleries"
                      :key="miniPicture.id"
                      class="pt"
                      @click="changeImage(miniPicture.photo)"
                      :class="
                        miniPicture.photo == default_image ? 'active' : ''
                      "
                    >
                      <img :src="miniPicture.photo" alt="" />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    setDataPicture(data) {
      // replace objeect productDeails dengan data dari API
  ...
  mounted() {
    ...
    axios
      ...
      // eslint-disable-next-lone no-console
